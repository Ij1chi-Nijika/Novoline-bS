...
public class ProfileManager implements IMinecraftInstance {
    ...
    void refreshProfileModules() {
        Module managerModule = ModuleManager.getModule(keystrokesmod.utility.profile.Manager.class);
        if (managerModule instanceof keystrokesmod.utility.profile.Manager) {
            ((keystrokesmod.utility.profile.Manager) managerModule).rebuildProfileSettings();
        }
    ...
    private static String migrateCategoryName(String categoryName) {
        ...
        if ("minigames".equals(categoryName) || "fun".equals(categoryName) || "other".equals(categoryName)) return "misc";
